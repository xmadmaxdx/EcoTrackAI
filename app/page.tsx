    ...
    <div className={`container mx-auto px-4 py-16 ${poppins.className}`}>
      <section className="text-center mb-20">
        ...
        <h1 className="text-6xl font-bold mb-6 text-gray-800 tracking-tight">
          EcoTrack AI: <span className="text-green-600"> Your SustainTrack Platform</span>
        </h1>
        <p className="text-xl text-gray-600 max-w-2xl mx-auto leading-relaxed mb-8">
        Join our network in enhancing resource management efficiency and incentivizing positive contributions!
        </p>
        {!loggedIn ? (
      ...
      <section className="grid md:grid-cols-3 gap-10 mb-20">
        <FeatureCard
          icon={Leaf}
          title="Eco-Conscious"
          description="Help create a cleaner planet by identifying and gathering recyclables."
        />
        <FeatureCard
          icon={Coins}
          title="Earn Rewards"
          description="Collect tokens for your efforts in sustainability practices."
        />
        <FeatureCard
          icon={Users}
          title="Community-Powered"
          description="Become a member of a flourishing community dedicated to eco-friendly solutions."
        />
      </section>

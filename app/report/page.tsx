  ...
  const handleVerify = async () => {
    ...
    try {
      ...
      const prompt = `You are an expert in waste management and recycling. Analyze this image and provide:
        ...
        Respond **only** in valid JSON format without any explanations or extra text. 
        Example response:
        {
          "wasteType": "plastic",
          "quantity": "0.5 kg",
      ...
      let text = await response.text(); // Ensure we get raw text properly
  
      // **Cleans JSON from possible formatting issues**
      text = text.trim();
      ...
      try {
        ...
        if (typeof parsedResult === "object" && parsedResult.wasteType && parsedResult.quantity && typeof parsedResult.confidence === "number") {

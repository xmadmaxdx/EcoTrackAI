...
console.log("Web3Auth ClientID:", clientId); // Verify it prints a valid value
const chainConfig = {
  chainNamespace: CHAIN_NAMESPACES.EIP155,
  chainId: "0xaa36a7",
  rpcTarget: "https://rpc.ankr.com/eth_sepolia",
  displayName: "Ethereum Sepolia sapphire_devnet",
  blockExplorerUrl: "https://sepolia.etherscan.io",
  ticker: "ETH",
  tickerName: "Ethereum",
  logo: "https://cryptologos.cc/logos/ethereum-eth-logo.png", // simanta remember here
};
        ...
        <div className="flex items-center">
          ...
          <Link href="/" className="flex items-center">
            ...
            <div className="flex flex-col">
              <span className="font-bold text-base md:text-lg text-gray-800">EcoTrack AI</span>
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="w-64">
              {notifications.length > 0 ? (
                ...
                <DropdownMenuItem>No Notifications Here</DropdownMenuItem>
              )}
            </DropdownMenuContent>
          </DropdownMenu>
